      ...
      {period === "custom" ? (
        <>
          <input
            ...
            className="h-11 rounded-[12px] border border-slate-200 bg-white px-3 text-sm text-navy outline-none focus:border-[#9bb6e0] focus:ring-4 focus:ring-[#5b82c4]/10"

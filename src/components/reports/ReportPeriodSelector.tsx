    ...
    <div className="flex flex-wrap items-center gap-2">
      <label className="relative inline-flex items-center">
        ...
        <select
          ...
          className="h-11 appearance-none rounded-[12px] border border-black/8 bg-white py-2 pl-10 pr-10 text-[13.5px] font-medium text-navy outline-none transition duration-200 focus:border-[#c9d7f5] focus:ring-4 focus:ring-[#3a6fd4]/10"
        >
      ...
      {period === "custom" ? (
        <>
          <input
            ...
            className="h-11 rounded-[12px] border border-black/8 bg-white px-3 text-sm text-navy outline-none focus:border-[#c9d7f5] focus:ring-4 focus:ring-[#3a6fd4]/10"

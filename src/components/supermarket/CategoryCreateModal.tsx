...
import { addProductCategory } from "@/lib/data/supermarket-inventory";
...
export function canCreateSupermarketCategory(user: AuthUser | null, isSuperAdmin: boolean) {
  ...
  return user.permissions.some((matcher) => matchPermission("supermarket.categories.create", matcher));
}
  ...
  return createPortal(
    <div className="fixed inset-0 z-[90] flex items-center justify-center px-4 py-6">
      ...
      >
        ...
        <p className="mt-1 text-[13px] text-slate-500">Create a category for products and stock.</p>
        <form
